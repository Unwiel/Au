function onCreate()
   ...
   makeAnimatedLuaSprite('warning', 'Cardodge', getProperty('boyfriend.x') -250, getProperty('boyfriend.y') -120)
     addAnimationByPrefix('warning', 'dou1', 'Alarm instance 1', 24, true)
     addLuaSprite('warning', true)
     setProperty('warning.alpha', 0)
    
     makeAnimatedLuaSprite('bones', 'Cardodge', getProperty('boyfriend.x') -200, getProperty('boyfriend.y') -100)
     addAnimationByPrefix('bones', 'dou2', 'Bones boi instance 1', 24, false)
     addLuaSprite('bones', true)
     setProperty('bones.alpha', 0)
    
    makeAnimatedLuaSprite('bfdodge', 'Cardodge', getProperty('boyfriend.x') +10, getProperty('boyfriend.y') +50)
