...
function onCreate()
	...
	makeAnimatedLuaSprite('cupfuck', 'characters/Cuphead Pissed', getProperty('dad.x') -250, getProperty('dad.y') -50)
	addAnimationByPrefix('cupfuck', 'fuck', 'Ouch instance 1', 24, false) 
	addLuaSprite('cupfuck', true) 
	scaleObject('cupfuck', 1.7, 1.7) 
	setProperty('cupfuck.visible', false)
	
	makeAnimatedLuaSprite('bfattack', 'characters/BoyFriend_Rain', getProperty('boyfriend.x') -1100, getProperty('boyfriend.y') +10)
...
function onTimerCompleted(tag) 
  ...
  if tag == 'a' then
       shootsxd = shootsxd + 1
       makeAnimatedLuaSprite('shit', 'bull/Cupheadshoot', getProperty('dad.x') +350 , getProperty('dad.y'))
       ...
       makeAnimatedLuaSprite('blue'.. shootsxd, 'bull/Cupheadshoot', getProperty('dad.x') +350 , updown[getRandomInt(1, #updown)]) 
